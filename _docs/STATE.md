...
```
top_pos        : 10        # 本轮消费循环[9]=10-逆向工程 → 下轮取循环[10]=11-性能分析
sub_pos        : 01:5 02:2 03:2 04:2 05:7 06:6 07:1 08:3 09:2 10:3 11:2  # 本轮消费 sub_pos[10]=2 → 46 协议逆向,已 +1
last_run       : 2026-09-21 20:01  # 20:00 槽占位锁(开局 20:00:38)
last_top       : 10-逆向工程  # 本轮;索引 46 协议逆向
skipped        : []
failed_attempts: []
```

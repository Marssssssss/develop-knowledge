...
```
top_pos        : 8        # 本轮大类 = 循环第 8 位 → 09-语言学习
sub_pos        : 01:0 02:1 03:1 04:1 05:1 06:1 07:1 08:1 09:0 10:0 11:0  # 各大类内子类目指针
last_run       : 2026-09-16 04:26
...
| 时间 | 索引 | 主题摘要 | 推进 | 累计 |
| --- | --- | --- | --- | --- |
| 2026-09-16 04:26 | 31 | 密码学第二批 5 个:SHA-3、HKDF、ECDSA+RFC6979、HOTP/TOTP、PBKDF2;向量全 PASS | +5 | 251 |
| 2026-09-16 02:14 | 27 | 关系型第二批 5 个:主从binlog、逻辑复制CDC、Join算法、物化视图、在线DDL | +5 | 246 |

"""CVSS v4.0 的常量表：层级、合法取值、宏向量得分、最高严重度向量与深度。

数据来自官方参考实现 FIRSTdotorg/cvss-v4-calculator（cvss_lookup.js /
cvss_score.js / max_composed.js / max_severity.js / metrics.js）。
本文件只放数据，算法在 cvss.py。
"""

# ---- 各指标取值 -> 严重度层级（越小越严重），与 cvss_score.js 的 *_levels 一致 ----
...
# 注意：SC 没有 S 取值；SI / SA 有（Safety 语义只给完整性与可用性）
...
LEVELS = {
    "AV": AV_LEVELS, "PR": PR_LEVELS, "UI": UI_LEVELS,
    "AC": AC_LEVELS, "AT": AT_LEVELS,
    "VC": VC_LEVELS, "VI": VI_LEVELS, "VA": VA_LEVELS,
    "SC": SC_LEVELS, "SI": SI_LEVELS, "SA": SA_LEVELS,
    "CR": CR_LEVELS, "IR": IR_LEVELS, "AR": AR_LEVELS,
    "E": E_LEVELS,
}

# ---- 合法取值与向量串中的固定顺序（metrics.js 的 expectedMetricOrder）----
VALID = {
...
# ---- 每个宏向量的最高严重度向量（max_composed.js）----
EQ1_MAX = {
    0: ["AV:N/PR:N/UI:N/"],
    1: ["AV:A/PR:N/UI:N/", "AV:N/PR:L/UI:N/", "AV:N/PR:N/UI:P/"],
    2: ["AV:P/PR:N/UI:N/", "AV:A/PR:L/UI:P/"],
}
EQ2_MAX = {0: ["AC:L/AT:N/"], 1: ["AC:H/AT:N/", "AC:L/AT:P/"]}
EQ3EQ6_MAX = {
...
EQ4_MAX = {0: ["SC:H/SI:S/SA:S/"], 1: ["SC:H/SI:H/SA:H/"], 2: ["SC:L/SI:L/SA:L/"]}
EQ5_MAX = {0: ["E:A/"], 1: ["E:P/"], 2: ["E:U/"]}

# ---- 宏向量"深度"+1（max_severity.js），乘 0.1 后作为分母 ----
DEPTH = {
    "eq1": {0: 1, 1: 4, 2: 5},
    "eq2": {0: 1, 1: 2},

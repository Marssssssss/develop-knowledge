...
```
top_pos        : 10       # 本轮大类 = 循环第 10 位 → 11-性能分析(下一轮)
sub_pos        : 01:0 02:1 03:1 04:1 05:1 06:1 07:1 08:1 09:1 10:1 11:0  # 各大类内子类目指针
last_run       : 2026-09-16 08:25
...
| 时间 | 索引 | 主题摘要 | 推进 | 累计 |
| --- | --- | --- | --- | --- |
| 2026-09-16 08:25 | 35 | 二进制逆向第三批 5 个:A64 编码+AAPCS64、Ghidra 流水线、headless、BinDiff 差分、脚本批量改名;217 断言 | +5 | 261 |
...
| 2026-09-16 00:10 | 23 | 容器化第二批 5 个:层缓存/多阶段/UID/rootless/cgroup v2 | +5 | 241 |

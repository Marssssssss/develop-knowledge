...
```
top_pos        : 2        # 下一轮取循环第 2 位 → 03-系统编程(本轮已取第 1 位 = 02-Web开发)
sub_pos        : 01:2 02:3 03:2 04:2 05:3 06:2 07:2 08:2 09:2 10:2 11:2  # 各大类内子类目指针
last_run       : 2026-09-18 08:24  # 08:00 槽收尾(实测 shell date);保险 45 分钟

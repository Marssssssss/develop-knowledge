...
```
top_pos        : 2         # 下轮取循环[2]=03-系统编程
sub_pos        : 01:5 02:2 03:1 04:1 05:6 06:5 07:0 08:2 09:1 10:2 11:2  # 本轮消费 sub_pos[02]=1 → 索引 9
last_run       : 2026-09-21 04:02  # 04:00 槽占位锁(开局 04:00:35)
last_top       : 02-Web开发  # 本轮消费循环[1] → 索引 9 后端
skipped        : []
failed_attempts: []
```

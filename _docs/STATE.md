...
```
top_pos        : 1        # 下一轮取循环第 1 位 → 02-Web开发(本轮已取第 0 位 = 01-游戏开发)
sub_pos        : 01:2 02:2 03:2 04:2 05:3 06:2 07:2 08:2 09:2 10:2 11:2  # 各大类内子类目指针
last_run       : 2026-09-18 08:02  # 08:00 槽占位锁(实测 shell date);保险 45 分钟

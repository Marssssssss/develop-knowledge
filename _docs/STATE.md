...
```
next_index     : 28    # 本轮选 27(07-数据存储/关系型)≠ 06-DevOps ✓;24-26 同大类顺延跳过不记 skip;完成 27,推进 27 → 28
last_run       : 2026-09-14 10:26   # 本轮占位锁 + 主轮结束时间
last_top       : 07-数据存储   # 本轮顶层大类 — 选 27 ✓ ≠ 上轮 06-DevOps
skipped        : []
failed_attempts: []
```

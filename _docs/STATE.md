...
```
top_pos        : 10        # 本轮已消费循环[9]=10-逆向工程(下轮[10]=11-性能分析)
sub_pos        : 01:7 02:4 03:0 04:0 05:0 06:0 07:3 08:1 09:0 10:1 11:4 12:0  # [10] 共 4 条目(35/36/46/57);本轮已消费 [10]=0→索引 35
last_run       : 2026-09-24 02:00
last_top       : 11-性能分析  # 索引 60 = 容量规划与性能建模首批(655-659;下轮 12-项目工程)
skipped        : []
failed_attempts: []
```

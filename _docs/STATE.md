...
```
top_pos        : 7        # 下一轮取循环第 7 位 → 08-安全(本轮已取第 6 位 = 07-数据存储)
sub_pos        : 01:1 02:2 03:2 04:2 05:3 06:2 07:2 08:1 09:1 10:1 11:1  # 各大类内子类目指针
last_run       : 2026-09-17 14:36  # 14:00 槽收尾(shell date 实测);轮间保险阈值 45 分钟
